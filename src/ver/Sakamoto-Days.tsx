...
const allEpisodes = {
  2: [
    ...
    {
      id: 2,
      title: "2. La batalla contra Son Hee y Bacho",
      duration: '25 min',
      description:
      ...
      thumbnail:
        'https://occ-0-4440-3934.1.nflxso.net/dnm/api/v6/9pS1daC2n6UGc3dUogvWIPMR_OU/AAAABaBcjldjdlZcE0pd-RnrvQv_2-em5sNhKRLtYgf9CY32AmJ91_KXzr55LNllpYTvryNqMSqrkM2aWcxIQPl1-ZOvWiB-e2PqwKpdXRvJQDXaS8VHMjMzz50I.webp?r=14f',
      releaseDate: 'Enero 18, 2022',
      episodeNumber: 'Sub | Dob',
    ...
    },
    {
      ...
      thumbnail:
        'https://cdn.jkdesu.com/assets/images/animes/video/image/jkvideo_1888ec27908c840e609605924d578c20.jpg',
      releaseDate: 'Enero 25, 2022, Filtrado',
      episodeNumber: 'Subtitulado',
      videoUrl: 'https://all-anime.net/frame/Sakamoto-days/T1/3.html',
    }
  ],
};
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                ...
                >
                  <option value={2}>Temporada 1</option>
                </select>
          ...
          <div className="bg-[#181818] rounded-lg w-full max-w-4xl relative">
            ...
            <div className="p-4 md:p-8">
              ...
              <div className="flex flex-wrap items-center gap-2 md:gap-4 mb-4 md:mb-6">
                <span className="text-green-500 font-semibold">Puntuación media: 4.5 (5.3k)</span>
                <span>2025</span>
                <span className="bg-[#30CA38] text-white px-2 py-0.5 rounded text-xs font-bold">
                  +16
                </span>
